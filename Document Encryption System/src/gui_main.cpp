...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    InitCommonControlsEx(&icex);
    const char CLASS_NAME[] = "CryptifyWndClass";
    ...
    RegisterClass(&wc);
    HWND hwnd = CreateWindowEx(0, CLASS_NAME, "Cryptify - Secure Document Encryption", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, CW_USEDEFAULT, CW_USEDEFAULT, 500, 420, NULL, NULL, hInstance, NULL);
    if (!hwnd) return 0;
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        int y = 20;
        HWND hTitle = CreateWindow("STATIC", "CRYPTIFY SECURITY ENGINE", WS_VISIBLE | WS_CHILD | SS_CENTER, 20, y, 440, 20, hwnd, NULL, hInst, NULL);
